function c = mynannancov(x,varargin)
...
%   $Revision: 1.1.6.6 $  $Date: 2009/08/29 08:33:02 $

if nargin<1
   error('stats:nancov:NotEnoughInputs', 'Not enough input arguments.');
end
...
if numel(varargin)>1
   error('stats:nancov:TooManyArgs','Too many arguments.');
end
